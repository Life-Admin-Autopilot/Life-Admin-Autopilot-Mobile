...
const EnvSchema = z.object({
  ...
  DOCUMENT_SCAN_STORAGE_DIR: z.string().optional(),
  DOCUMENT_SCAN_MAX_BYTES: z.coerce.number().int().positive().default(15 * 1024 * 1024),
  DOCUMENT_SCAN_MAX_PAGES: z.coerce.number().int().positive().default(20),
  DOCUMENT_SCAN_QUOTA_FREE_MONTHLY: z.coerce.number().int().positive().default(20),
  DOCUMENT_SCAN_QUOTA_PRO_MONTHLY: z.coerce.number().int().positive().default(200),
